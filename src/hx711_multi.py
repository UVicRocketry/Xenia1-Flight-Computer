...
__timeout [int]: Max time in milliseconds to wait for HX711s to become
...
tare()
    ...
    This is just like tareing a scale to offset the mass of the empty bowl on
    ...
    num_of_samples [int]
        ...
        NOTE: num_of_samples must be greater than or equal to 100 or tare will
        fail. This is to obtain an accurate statistical reading.
